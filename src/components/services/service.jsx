...
function Service() {
  return (
    <div className='lg:w-[1024px] w-[95%] mx-auto sm:my-[6em] my-[3em]'>
        ...
        <div className='lg:flex hidden gap-[3em] justify-between items-center mt-6'>
            <div className='transition-all lg:w-[320px] w-full  hover:shadow-lg hover:shadow-[#8B41D2] grid place-items-center border border-[#eeeeee] rounded-[32px] h-[300px]'>
